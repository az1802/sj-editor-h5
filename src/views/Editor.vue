...
const adjustHeightOnUpload = (event: { data: any; key: string }) => {
  ...
  <a-layout>
    <a-layout-header class="header">
      <div class="page-title">
        ...
        <InputEdit :value="pageState?.title || '默认标题'" @change="titleChange">
      ...
      >
        ...
        <a-menu-item key="3">
          <a-button type="primary" @click="publishWork" :loading="isPublishing">
            发布
          </a-button>
        </a-menu-item>
        <a-menu-item key="4">
  ...
  <a-layout>
    <a-layout-sider width="400" style="background: #fff">
      <div class="sidebar-container">
        <ComponentList @onItemClick="onItemCreated"></ComponentList>
      </div>
    </a-layout-sider>
    <a-layout style="padding: 0 24px 24px">
      <a-layout-content class="preview-container" @mousedown="clearSelection">
        <p>画布区域{{ components.length }}</p>
        ...
        <a-tab-pane key="component" tab="属性设置" class="no-top-radius">
          <div v-if="currentElement">
            <div v-if="!currentElement.isLocked">
              <EditGroup :props="currentElement.props"></EditGroup>
            </div>
            <div v-else>
              <a-empty>
